...
public class ThuePhong extends JFrame{
	private JTextField tenPhongF, loaiPhongF, giaPhongF, sucChuaF, tinhTrangF, sdtKhachF, tenKhachF, ngayNhanF, gioNhanF;
	...
	public ThuePhong() {
		...
		ngayNhanBox.add(ngayNhanF = new JTextField(15));
		...
		gioNhanBox.add(gioNhanF = new JTextField(15));
		...
		ngayNhanF.setEditable(false);
		gioNhanF.setEditable(false);
